...
1. **Read brand context:**
   - `brand/voice-profile.md` (fall back to `brand/voice.md`) — the voice standard to review against
...
3. **Review on six dimensions:**
   ...
   **AI Detection** (does it sound human?)
   ...
   Flag any of these:
   - **Banned words:** delve, comprehensive, robust, cutting-edge, utilize, leverage, crucial, unlock, unleash, supercharge, game-changer, landscape, navigate, streamline, elevate, foster, empower
   - **Banned phrases:** "In today's fast-paced world," "It's important to note," "Whether you're a... or a...," "Let's dive in," "Without further ado," "I hope this finds you well," "Don't hesitate to"
   - **Structural tells:** Every paragraph same length. No contractions. Passive voice throughout. Hedging ("may potentially," "could possibly"). Lists of exactly 3 items every time. Too many em-dashes.
   - **Voice tells:** No "I" or "you." No opinions without qualifiers. No fragments. No unexpected word choices. Reads like a committee wrote it.
