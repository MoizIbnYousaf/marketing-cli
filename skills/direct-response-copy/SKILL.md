...
6. Check `marketing/campaigns/` for existing copy — if found, ask: revise, add new, or start fresh?
...
See [references/plain-english-alternatives.md](references/plain-english-alternatives.md) for comprehensive list.
