...
slides:
  - index: number                  # 1-based slide number
    ...
    label: string | null           # Small section label (e.g., "DHIKR SYSTEM")
...
voice_constraints:
  tone: string                     # e.g., "calm, certain, spiritually grounded"
...
Examples:
- `marketing/content-specs/halalscreen-aida.yaml`
- `marketing/content-specs/halalscreen-pas.yaml`
