...
describe("e2e: published package.json description carries canonical skill count", () => {
  test("package.json description references 56 (canonical total)", () => {
  ...
  test("all 4 plugin manifest descriptions reference 56", () => {
    ...
    expect(codex.interface.longDescription).toContain("55 marketing skills");
  });
});
